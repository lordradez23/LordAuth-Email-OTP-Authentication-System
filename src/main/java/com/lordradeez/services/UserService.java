        ...
        return """
            ...
            <head>
              ...
              <style>
                ...
                .card { background:linear-gradient(135deg,#1e293b,#0f172a); border:1px solid rgba(255,255,255,0.08); border-radius:16px; overflow:hidden; }
                ...
                .otp-box { background:rgba(99,102,241,0.15); border:2px solid #6366f1; border-radius:12px; padding:20px; text-align:center; margin-bottom:24px; }
                .otp-code { color:#818cf8; font-size:42px; font-weight:900; letter-spacing:12px; }
